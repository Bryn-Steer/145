    ...
    <div className="booking-system-form">
      <form className={bookingStyle} onSubmit={handleSubmit}>
        <div className="select">
          ...
          >
            <option value={inputs.option || "One"}>One Person</option>
            <option value={inputs.option || "Two"}>Two People</option>
            <option value={inputs.option || "Three"}>Three People</option>
            <option value={inputs.option || "Four"}>Four People</option>
            <option value={inputs.option || "Five"}>Five People</option>
            <option value={inputs.option || "Six"}>Six People</option>
          </select>
